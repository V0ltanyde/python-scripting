...
class classNLTKQuery:
    ...
    def printVocabSize(self):
        ...
        for word in words:
            wordSet.add(word)
        print("Vocabulary Size:   ", len(wordSet))
    ...
    def searchWordOccurrence(self):
        ...
        if myWord:
            ...
            total = self.tokens.count(myWord)
            print(myWord, " occurred:  ", str(total))
    ...
    def generateConcordance(self):
        ...
        if myWord:
            ...
            print(self.TextCorpus.concordance(myWord))          
    ...
    def generateSimiliarities(self):
        ...
        if myWord:
            ...
            print(self.TextCorpus.similar(myWord))   
    ...
    def printWordIndex(self):
        ...
        if myWord:
            ...
            print("The first occurence of", myWord, "is offset at:", self.TextCorpus.index(myWord))
